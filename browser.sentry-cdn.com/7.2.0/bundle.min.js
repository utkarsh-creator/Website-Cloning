...
var Sentry = function(t) {
    ...
    function p(t, n) {
        try {
            ...
            var r = " > ".length;
            let u;
            for (; i && s++ < 5 && (u = y(i, n), !("html" === u || s > 1 && o + e.length * r + u.length >= 80));) e.push(u), o += u.length, i = i.parentNode;
    ...
    function y(t, n) {
        ...
        for (a = 0; a < h.length; a++) o = h[a], u = e.getAttribute(o), u && r.push(`[${o}="${u}"]`);
        return r.join("")
    }
    ...
    function w(t) {
        return "string" == typeof t ? function(t) {
            var n = g.exec(t);
            if (!n) throw new m(`Invalid Sentry Dsn: ${t}`);
    ...
    function T(t, n) {
        var e = n.prototype || {};
        t.prototype = n.prototype = e, j(t, "__sentry_original__", n)
    }
    ...
    function R(t) {
        ...
        if (l(t)) {
            ...
            return "undefined" != typeof CustomEvent && d(t, CustomEvent) && (n.detail = t.detail), n
        }
        return t
    }
    ...
    function I(t) {
        try {
            return n = t, "undefined" != typeof Element && d(n, Element) ? p(t) : Object.prototype.toString.call(t)
        } catch (t) {
            return "<unknown>"
        }
        var n
    ...
    function C(t, n = 40) {
        ...
        if (e[0].length >= n) return S(e[0], n);
        for (let t = e.length; t > 0; t--) {
            var r = e.slice(0, t).join(", ");
            if (!(r.length > n)) return t === e.length ? r : S(r, n)
        }
        return ""
    }
    ...
    function N(t, n) {
        if (h(t)) {
            if (void 0 !== (i = n.get(t))) return i;
            var e = {};
            for (var r of (n.set(t, e), Object.keys(t))) void 0 !== t[r] && (e[r] = N(t[r], n));
            return e
        }
        if (Array.isArray(t)) {
            var i;
        ...
        if (!X[t]) switch (X[t] = !0, t) {
            ...
            case "dom":
                ! function() {
                    ...
                    var t = J.bind(null, "dom"),
                        n = Z(t, !0);
                    F.document.addEventListener("click", n, !1), F.document.addEventListener("keypress", n, !1), ["EventTarget", "Node"].forEach((n => {
            ...
            case "xhr":
                ! function() {
                    ...
                    O(t, "open", (function(t) {
                        ...
                        return function(...n) {
                            return this.__sentry_xhr__ && void 0 !== n[0] && (this.__sentry_xhr__.body = n[0]), J("xhr", {
                                args: n,
                                startTimestamp: Date.now(),
                                xhr: this
                            }), t.apply(this, n)
                ...
                ! function() {
                    if (! function() {
                            ...
                            if (r && "function" == typeof r.createElement) try {
                                ...
                                i.hidden = !0, r.head.appendChild(i), i.contentWindow && i.contentWindow.fetch && (n = H(i.contentWindow.fetch)), r.head.removeChild(i)
                            } catch (t) {}
                            return n
                        }()) return;
            ...
            case "history":
                ! function() {
                    ...
                    }, O(F.history, "pushState", n), O(F.history, "replaceState", n)
                }();
                break;
            case "error":
                tt = F.onerror, F.onerror = function(t, n, e, r, i) {
                    return J("error", {
                        column: r,
                        error: i,
                        line: e,
            ...
            case "unhandledrejection":
                nt = F.onunhandledrejection, F.onunhandledrejection = function(t) {
                    return J("unhandledrejection", t), !nt || nt.apply(this, arguments)
                };
                break;
            default:
                return
    ...
    function W(t, n) {
        B[t] = B[t] || [], B[t].push(n), z(t)
    }

    function J(t, n) {
        if (t && B[t])
            for (var e of B[t] || []) try {
                e(n)
            } catch (t) {}
    }
        ...
        return e => {
            if (e && Y !== e && ! function(t) {
                ...
                (void 0 === Q || function(t, n) {
                    ...
                    name: r,
                    global: n
                }), Y = e), clearTimeout(Q), Q = F.setTimeout((() => {
                    Q = void 0
                }), 1e3)
            }
        }
    ...
    function ht(t, n, e = 1 / 0, r = 1 / 0, i = function() {
        ...
        if (null === n || ["number", "boolean", "string"].includes(typeof n) && ("number" != typeof(u = n) || u == u)) return n;
        var c = function(t, n) {
            try {
    ...
    class pt {
        ...
        __init5() {
            this.v = (t, n) => {
                this.i === lt.PENDING && (v(n) ? n.then(this.u, this.h) : (this.i = t, this.p = n, this.l()))
            }
        }
        __init6() {
            this.l = () => {
    ...
    function yt(t) {
        ...
        return {
            $: n,
            add: function(r) {
                if (!(void 0 === t || n.length < t)) return dt(new m("Not adding Promise due to buffer limit reached."));
                var i = r();
    ...
    var gt = ["fatal", "error", "warning", "log", "info", "debug"];
    var _t = {
    ...
    function jt(t, n) {
        ...
        function s(t) {
            "string" == typeof i ? i = "string" == typeof t ? i + t : [Ot(i, n), t] : i.push("string" == typeof t ? Ot(t, n) : t)
        }
        for (var o of r) {
            const [t, n] = o;
        ...
        return "string" == typeof i ? i : function(t) {
            var n = t.reduce(((t, n) => t + n.length), 0),
                e = new Uint8Array(n);
            let r = 0;
            for (var i of t) e.set(i, r), r += i.length;
            return e
        }(i)
    }

    function Tt(t, n) {
        var e = "string" == typeof t.data ? Ot(t.data, n) : t.data;
        return [A({
            type: "attachment",
            length: e.length,
            filename: t.filename,
    ...
    function Ct(t, n = {}) {
        if (n.user && (!t.ipAddress && n.user.ip_address && (t.ipAddress = n.user.ip_address), t.did || n.did || (t.did = n.user.id || n.user.email || n.user.username)), t.timestamp = n.timestamp || Et(), n.ignoreDuration && (t.ignoreDuration = n.ignoreDuration), n.sid && (t.sid = 32 === n.sid.length ? n.sid : et()), void 0 !== n.init && (t.init = n.init), !t.did && n.did && (t.did = `${n.did}`), "number" == typeof n.started && (t.started = n.started), t.ignoreDuration) t.duration = void 0;
    ...
    class At {
        ...
        static clone(t) {
            ...
            }, n.k = t.k, n.I = t.I, n.M = t.M, n.C = t.C, n.A = t.A, n.N = t.N, n._ = [...t._], n.L = t.L, n.D = [...t.D]), n
        }
        addScopeListener(t) {
            this.g.push(t)
        }
        ...
        setUser(t) {
            return this.k = t || {}, this.C && Ct(this.C, {
                user: t
            }), this.U(), this
        }
        getUser() {
        ...
        setContext(t, n) {
            return null === n ? delete this.T[t] : this.T = { ...this.T,
                [t]: n
            }, this.U(), this
        }
        setSpan(t) {
        ...
        update(t) {
            ...
            if ("function" == typeof t) {
                var n = t(this);
                return n instanceof At ? n : this
            }
            return t instanceof At ? (this.O = { ...this.O,
                ...t.O
            }, this.j = { ...this.j,
                ...t.j
            }, this.T = { ...this.T,
                ...t.T
            }, t.k && Object.keys(t.k).length && (this.k = t.k), t.I && (this.I = t.I), t.N && (this.N = t.N), t.L && (this.L = t.L)) : h(t) && (t = t, this.O = { ...this.O,
                ...t.tags
            }, this.j = { ...this.j,
                ...t.extra
            }, this.T = { ...this.T,
                ...t.contexts
            }, t.user && (this.k = t.user), t.level && (this.I = t.level), t.fingerprint && (this.N = t.fingerprint), t.requestSession && (this.L = t.requestSession)), this
        }
        clear() {
            return this.S = [], this.O = {}, this.j = {}, this.k = {}, this.T = {}, this.I = void 0, this.A = void 0, this.N = void 0, this.L = void 0, this.M = void 0, this.C = void 0, this.U(), this.D = [], this
        }
        addBreadcrumb(t, n) {
        ...
        applyToEvent(t, n = {}) {
            if (this.j && Object.keys(this.j).length && (t.extra = { ...this.j,
                    ...t.extra
                }), this.O && Object.keys(this.O).length && (t.tags = { ...this.O,
                    ...t.tags
                }), this.k && Object.keys(this.k).length && (t.user = { ...this.k,
                    ...t.user
                }), this.T && Object.keys(this.T).length && (t.contexts = { ...this.T,
                    ...t.contexts
                }), this.I && (t.level = this.I), this.A && (t.transaction = this.A), this.M) {
                t.contexts = {
            ...
            return this.q(t), t.breadcrumbs = [...t.breadcrumbs || [], ...this.S], t.breadcrumbs = t.breadcrumbs.length > 0 ? t.breadcrumbs : void 0, t.sdkProcessingMetadata = this.R, this.P([...Nt(), ...this._], t, n)
        }
        ...
        q(t) {
            t.fingerprint = t.fingerprint ? Array.isArray(t.fingerprint) ? t.fingerprint : [t.fingerprint] : [], this.N && (t.fingerprint = t.fingerprint.concat(this.N)), t.fingerprint && !t.fingerprint.length && delete t.fingerprint
        }
    }
    ...
    class qt {
        ...
        constructor(t, n = new At, e = 4) {
            this.F = e, qt.prototype.__init.call(this), this.getStackTop().scope = n, t && this.bindClient(t)
        }
        isOlderThan(t) {
            return this.F < t
        }
    ...
    function Ft() {
        var t, n = Pt();
        return (t = n) && t.__SENTRY__ && t.__SENTRY__.hub && !Bt(n).isOlderThan(4) || Xt(n, new qt), Bt(n)
    }

    function Bt(t) {
        return r("hub", (() => new qt), t)
    }
    ...
    function Kt(t, n) {
        return n || `${function(t){return`${Wt(t)}${t.projectId}/envelope/`}(t)}?${Jt(t)}`
    }
    ...
    function Vt(t, n, e, r) {
        ...
        }(t, e && e.sdk), delete t.sdkProcessingMetadata;
        var c = function(t, n, e, r) {
            var i = t.contexts && t.contexts.baggage;
            const {
                environment: s,
                release: o,
                transaction: u,
    ...
    class tn {
        ...
        captureEvent(t, n, e) {
            if (n && n.originalException && at(n.originalException)) return;
            let r = n && n.event_id;
        ...
        setupIntegrations() {
            ...
            this.it() && !this.G && (this.K = (t = this.Z.integrations, n = {}, t.forEach((t => {
                n[t.name] = t, -1 === Qt.indexOf(t.name) && (t.setupOnce(Lt, Ft), Qt.push(t.name))
            })), n), this.G = !0)
        }
        ...
        sendEvent(t, n = {}) {
            if (this.tt) {
                ...
                for (var e of n.attachments || []) r = $t(r, Tt(e, mt([this, "access", t => t.Z, "access", t => t.transportOptions, "optionalAccess", t => t.textEncoder])));
                this.ut(r)
            }
        }
        sendSession(t) {
        ...
        ct(t, n, e) {
            ...
            var s = { ...t,
                ...
                timestamp: t.timestamp || xt()
            };
            this.ft(s), this.ht(s);
            let o = e;
            n.captureContext && (o = At.clone(o).update(n.captureContext));
            let u = vt(s);
            if (o) {
                var a = [...n.attachments || [], ...o.getAttachments()];
                a.length && (n.attachments = a), u = o.applyToEvent(s, n)
            }
        ...
        lt(t, n, e) {
            ...
            return t.contexts && t.contexts.trace && r.contexts && (r.contexts.trace = t.contexts.trace, t.contexts.trace.data && (r.contexts.trace.data = ct(t.contexts.trace.data, n, e))), t.spans && (r.spans = t.spans.map((t => (t.data && (t.data = ct(t.data, n, e)), t)))), r
        }
        ft(t) {
            ...
            "environment" in t || (t.environment = "environment" in n ? e : "production"), void 0 === t.release && void 0 !== r && (t.release = r), void 0 === t.dist && void 0 !== i && (t.dist = i), t.message && (t.message = S(t.message, s));
        ...
        vt(t, n, e) {
            ...
            if (!this.it()) return dt(new m("SDK not enabled, will not capture event."));
            var s = "transaction" === t.type;
            return !s && "number" == typeof i && Math.random() > i ? (this.recordDroppedEvent("sample_rate", "error"), dt(new m(`Discarding event because it's not included in the random sample (sampling rate = ${i})`))) : this.ct(t, n, e).then((e => {
                if (null === e) throw this.recordDroppedEvent("event_processor", t.type || "error"), new m("An event processor returned null, will not send event.");
                return n.data && !0 === n.data.__sentry__ || s || !r ? e : function(t) {
                    var n = "`beforeSend` method has to return `null` or a valid event.";
                    if (v(t)) return t.then((t => {
                        if (!h(t) && null !== t) throw new m(n);
                        return t
                    }), (t => {
                ...
                return !s && i && this.at(i, r), this.sendEvent(r, n), r
            })).then(null, (t => {
        ...
        et(t) {
            this.V += 1, t.then((t => (this.V -= 1, t)), (t => (this.V -= 1, t)))
        }
        ut(t) {
        ...
        dt() {
            var t = this.Y;
            return this.Y = {}, Object.keys(t).map((n => {
                const [e, r] = n.split(":");
                return {
                    reason: e,
                    category: r,
        ...
        return {
            send: function(i) {
                ...
                if (kt(i, ((n, e) => {
                    ...
                    })), 0 === s.length) return vt();
                var o = St(i[0], s),
                    u = n => {
                        kt(o, ((e, r) => {
                            t.recordDroppedEvent(n, Rt(r))
                        }))
                    };
                return e.add((() => n({
                    body: jt(o, t.textEncoder)
                }).then((t => {
                    r = It(r, t)
                }), (t => {
                    u("network_error")
                })))).then((t => t), (t => {
                    if (t instanceof m) return u("queue_overflow"), vt();
                    throw t
                }))
            },
            flush: t => e.drain(t)
    ...
    class sn {
        ...
        setupOnce() {
            rn = Function.prototype.toString, Function.prototype.toString = function(...t) {
                var n = D(this) || this;
                return rn.apply(n, t)
            }
        }
    ...
    class un {
        ...
        constructor(t = {}) {
            this.Z = t, un.prototype.__init.call(this)
        }
        setupOnce(t, n) {
            var e = t => {
                var e = n();
    ...
    const vn = /Minified React error #\d+;/i;
    ...
    function pn(t, n, e, r, i) {
        ...
        return c = yn(t, n, e, r), ot(c, `${n}`, void 0), ut(c, {
            synthetic: !0
        }), c
    }
    ...
    class gn {
        ...
        constructor(t) {
            gn.prototype.__init.call(this), this.options = {
                console: !0,
                dom: !0,
                fetch: !0,
                history: !0,
        ...
        setupOnce() {
            this.options.console && W("console", _n), this.options.dom && W("dom", function(t) {
                function n(n) {
                ...
                return n
            }(this.options.dom)), this.options.xhr && W("xhr", bn), this.options.fetch && W("fetch", wn), this.options.history && W("history", xn)
        }
    }
    ...
    function _n(t) {
        const n = {
            ...
            level: (e = t.level, "warn" === e ? "warning" : gt.includes(e) ? e : "log"),
            message: $(t.args, " ")
        };
        var e;
        if ("assert" === t.level) {
    ...
    function wn(t) {
        t.endTimestamp && (t.fetchData.url.match(/sentry_key/) && "POST" === t.fetchData.method || (t.error ? Ft().addBreadcrumb({
            category: "fetch",
            data: t.fetchData,
            level: "error",
            type: "http"
    ...
    function xn(t) {
        ...
        let o = rt(r);
        const u = rt(i);
        o.path || (o = s), s.protocol === u.protocol && s.host === u.host && (i = u.relative), s.protocol === o.protocol && s.host === o.host && (r = o.relative), Ft().addBreadcrumb({
            category: "navigation",
            data: {
                from: r,
                to: i
    ...
    function $n() {
        if (Sn) return Sn;
        if (H(En.fetch)) return Sn = En.fetch.bind(En);
        const t = En.document;
        let n = En.fetch;
    ...
    class On extends tn {
        constructor(t) {
            t.ot = t.ot || {}, t.ot.sdk = t.ot.sdk || {
                ...
                version: en
            }, super(t), t.sendClientReports && kn.document && kn.document.addEventListener("visibilitychange", (() => {
        ...
        eventFromException(t, n) {
            return function(t, n, e, r) {
                ...
                return ut(i), i.level = "error", e && e.event_id && (i.event_id = e.event_id), vt(i)
        ...
        sendEvent(t, n) {
            ...
            e && e.options && e.options.sentry && Ft().addBreadcrumb({
        ...
        yt() {
            ...
            if (!this.tt) return;
            const n = Kt(this.tt, this.Z.tunnel),
                e = (r = t, St((i = this.Z.tunnel && _(this.tt)) ? {
                    dsn: i
                } : {}, [
                    [{
                        type: "client_report"
    ...
    const In = /^\s*at (?:(.*?) ?\((?:address at )?)?((?:file|https?|blob|chrome-extension|address|native|eval|webpack|<anonymous>|[-a-z]+:|.*bundle|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i,
        ...
        Ln = [50, t => {
            ...
            if (n) {
                ...
                let t = n[3],
                    e = n[1] || Dn;
                return [e, t] = Wn(e, t), Rn(t, e, n[4] ? +n[4] : void 0, n[5] ? +n[5] : void 0)
            }
        }],
    ...
    function Vn(t, n = {}, e) {
        ...
        const sentryWrapped = function() {
            ...
            try {
                ...
                throw Gn(), zt((e => {
                    e.addEventProcessor((t => (n.mechanism && (ot(t, void 0, void 0), ut(t, n.mechanism)), t.extra = { ...t.extra,
                        arguments: r
        ...
        T(sentryWrapped, t), j(t, "__sentry_wrapped__", sentryWrapped);
        try {
    ...
    class Qn {
        ...
        constructor(t) {
            Qn.prototype.__init.call(this), Qn.prototype.__init2.call(this), this.Z = {
                onerror: !0,
    ...
    function Yn() {
        W("error", (t => {
            ...
            if (Kn() || f && f.__sentry_own_request__) return;
            ...
            h.level = "error", ne(n, f, h, "onerror")
        }))
    }
    ...
    function Zn() {
        W("unhandledrejection", (t => {
            ...
            if (Kn() || i && i.__sentry_own_request__) return !0;
            const s = f(i) ? {
                exception: {
                    values: [{
            ...
            s.level = "error", ne(n, i, s, "onunhandledrejection")
        }))
    }
    ...
    class ie {
        ...
        constructor(t) {
            ie.prototype.__init.call(this), this.Z = {
                XMLHttpRequest: !0,
                eventTarget: !0,
        ...
        setupOnce() {
            const t = e();
            this.Z.setTimeout && O(t, "setTimeout", se), this.Z.setInterval && O(t, "setInterval", se), this.Z.requestAnimationFrame && O(t, "requestAnimationFrame", oe), this.Z.XMLHttpRequest && "XMLHttpRequest" in t && O(XMLHttpRequest.prototype, "send", ue);
            ...
            return ["onload", "onerror", "onprogress", "onreadystatechange"].forEach((t => {
                t in e && "function" == typeof e[t] && O(e, t, (function(n) {
                    const e = {
                        ...
                        r = D(n);
                    return r && (e.mechanism.data.handler = q(r)), Vn(n, e)
                }))
            })), t.apply(this, n)
        }
    }
    ...
    class ce {
        ...
        constructor(t = {}) {
            ce.prototype.__init.call(this), this._t = t.key || "cause", this.bt = t.limit || 5
        }
        setupOnce() {
            const t = Ft().getClient();
            t && Lt(((n, e) => {
                const r = Ft().getIntegration(ce);
                return r ? function(t, n, e, r, i) {
                    if (!(r.exception && r.exception.values && i && d(i.originalException, Error))) return r;
    ...
    function fe(t, n, e, r, i = []) {
        if (!d(e[r], Error) || i.length + 1 >= n) return i;
        const s = fn(t, e[r]);
    ...
    const _e = [new un, new sn, new ie, new gn, new Qn, new ce, new ve, new le];
    ...
    return t.Breadcrumbs = gn, t.BrowserClient = On, t.Dedupe = ve, t.FunctionToString = sn, t.GlobalHandlers = Qn, t.HttpContext = le, t.Hub = qt, t.InboundFilters = un, t.Integrations = Ee, t.LinkedErrors = ce, t.SDK_VERSION = en, t.Scope = At, t.TryCatch = ie, t.addBreadcrumb = function(t) {
        Ft().addBreadcrumb(t)
    }, t.addGlobalEventProcessor = Lt, t.captureEvent = function(t, n) {
        return Ft().captureEvent(t, n)
    }, t.captureException = captureException, t.captureMessage = function(t, n) {
        var e = "string" == typeof n ? n : void 0,
            r = "string" != typeof n ? {
                captureContext: n
            } : void 0;
        return Ft().captureMessage(t, e, r)
    }, t.chromeStackLineParser = Cn, t.close = function(t) {
        const n = Ft().getClient();
        return n ? n.close(t) : vt(!1)
    }, t.configureScope = function(t) {
        Ft().configureScope(t)
    }, t.createTransport = nn, t.defaultIntegrations = _e, t.defaultStackLineParsers = Xn, t.defaultStackParser = zn, t.flush = function(t) {
        const n = Ft().getClient();
        return n ? n.flush(t) : vt(!1)
    }, t.forceLoad = function() {}, t.geckoStackLineParser = Ln, t.getCurrentHub = Ft, t.getHubFromCarrier = Bt, t.init = function(t = {}) {
        ...
        const n = { ...t,
            stackParser: (r = t.stackParser || zn, Array.isArray(r) ? L(...r) : r),
            integrations: Zt(t),
        ...
        ! function(t, n) {
            ...
            var i = new t(n);
            e.bindClient(i)
        }(On, n), t.autoSessionTracking && function() {
            const t = e();
            if (void 0 === t.document) return;
            const n = Ft();
    ...
    }, t.makeFetchTransport = jn, t.makeMain = Ht, t.makeXHRTransport = Tn, t.onLoad = function(t) {
        t()
    }, t.opera10StackLineParser = Hn, t.opera11StackLineParser = Bn, t.setContext = function(t, n) {
        Ft().setContext(t, n)
        ...
        Ft().setUser(t)
    }, t.showReportDialog = function(t = {}, n = Ft()) {
        const r = e();
        if (!r.document) return;
        const {
            client: i,
            scope: s
        } = n.getStackTop(), o = t.dsn || i && i.getDsn();
        if (!o) return;
        s && (t.user = { ...s.getUser(),
            ...t.user
        }), t.eventId || (t.eventId = n.lastEventId());
        const u = r.document.createElement("script");
        u.async = !0, u.src = function(t, n) {
            var e = w(t),
                r = `${Wt(e)}embed/error-page/`;
            let i = `dsn=${_(e)}`;
            for (var s in n)
                if ("dsn" !== s)
                    if ("user" === s) {
                    ...
                    } else i += `&${encodeURIComponent(s)}=${encodeURIComponent(n[s])}`;
            return `${r}?${i}`
        }(o, t), t.onLoad && (u.onload = t.onLoad);
        const a = r.document.head || r.document.body;
        a && a.appendChild(u)
    }, t.startTransaction = function(t, n) {
        return Ft().startTransaction({ ...t
        }, n)
    }, t.winjsStackLineParser = qn, t.withScope = zt, t.wrap = function(t) {
        return Vn(t)()
    }, t
}({});
